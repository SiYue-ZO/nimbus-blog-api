...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.BlogURL = field.NewString(tableName, "blog_url")
	_user.AuthProvider = field.NewString(tableName, "auth_provider")
	_user.AuthOpenid = field.NewString(tableName, "auth_openid")
	_user.ShowFullProfile = field.NewBool(tableName, "show_full_profile")
...
type user struct {
	...
	Region          field.String
	BlogURL         field.String
	AuthProvider    field.String
	AuthOpenid      field.String
	ShowFullProfile field.Bool
...
func (u *user) updateTableName(table string) *user {
	...
	u.BlogURL = field.NewString(table, "blog_url")
	u.AuthProvider = field.NewString(table, "auth_provider")
	u.AuthOpenid = field.NewString(table, "auth_openid")
	u.ShowFullProfile = field.NewBool(table, "show_full_profile")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["blog_url"] = u.BlogURL
	u.fieldMap["auth_provider"] = u.AuthProvider
	u.fieldMap["auth_openid"] = u.AuthOpenid
	u.fieldMap["show_full_profile"] = u.ShowFullProfile
