...
func newFeedback(db *gorm.DB, opts ...gen.DOOption) feedback {
	...
	_feedback.Name = field.NewString(tableName, "name")
	_feedback.Email = field.NewString(tableName, "email")
	_feedback.Type = field.NewString(tableName, "type")
	_feedback.Subject = field.NewString(tableName, "subject")
	_feedback.Message = field.NewString(tableName, "message")
	_feedback.Status = field.NewString(tableName, "status")
	_feedback.IPAddress = field.NewString(tableName, "ip_address")
	_feedback.UserAgent = field.NewString(tableName, "user_agent")
...
func (f *feedback) updateTableName(table string) *feedback {
	...
	f.Subject = field.NewString(table, "subject")
