...
func newAdmin(db *gorm.DB, opts ...gen.DOOption) admin {
	...
	_admin.PasswordHash = field.NewString(tableName, "password_hash")
	_admin.Nickname = field.NewString(tableName, "nickname")
	_admin.Specialization = field.NewString(tableName, "specialization")
	_admin.MustResetPassword = field.NewBool(tableName, "must_reset_password")
	_admin.TwoFactorSecret = field.NewString(tableName, "two_factor_secret")
...
type admin struct {
	...
	MustResetPassword field.Bool
	TwoFactorSecret   field.String
...
func (a *admin) updateTableName(table string) *admin {
	...
	a.Specialization = field.NewString(table, "specialization")
	a.MustResetPassword = field.NewBool(table, "must_reset_password")
	a.TwoFactorSecret = field.NewString(table, "two_factor_secret")
...
func (a *admin) fillFieldMap() {
	...
	a.fieldMap["specialization"] = a.Specialization
	a.fieldMap["must_reset_password"] = a.MustResetPassword
	a.fieldMap["two_factor_secret"] = a.TwoFactorSecret
