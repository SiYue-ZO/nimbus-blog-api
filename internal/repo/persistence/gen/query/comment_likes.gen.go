...
func newCommentLike(db *gorm.DB, opts ...gen.DOOption) commentLike {
	...
	_commentLike.CommentID = field.NewInt64(tableName, "comment_id")
	_commentLike.UserID = field.NewInt64(tableName, "user_id")
	_commentLike.LikedAt = field.NewTime(tableName, "liked_at")
...
func (c *commentLike) updateTableName(table string) *commentLike {
	...
	c.LikedAt = field.NewTime(table, "liked_at")
