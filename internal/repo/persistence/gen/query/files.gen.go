...
func newFile(db *gorm.DB, opts ...gen.DOOption) file {
	...
	_file.ResourceID = field.NewInt64(tableName, "resource_id")
	_file.UploaderID = field.NewInt64(tableName, "uploader_id")
...
func (f *file) updateTableName(table string) *file {
	...
	f.ResourceID = field.NewInt64(table, "resource_id")
	f.UploaderID = field.NewInt64(table, "uploader_id")
...
func (f *file) fillFieldMap() {
	...
	f.fieldMap["resource_id"] = f.ResourceID
