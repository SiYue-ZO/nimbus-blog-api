...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.FeaturedImage = field.NewString(tableName, "featured_image")
	...
	_post.ReadTime = field.NewString(tableName, "read_time")
	_post.Views = field.NewInt32(tableName, "views")
	_post.Likes = field.NewInt32(tableName, "likes")
	_post.IsFeatured = field.NewBool(tableName, "is_featured")
	_post.MetaTitle = field.NewString(tableName, "meta_title")
	_post.MetaDescription = field.NewString(tableName, "meta_description")
	_post.PublishedAt = field.NewTime(tableName, "published_at")
...
func (p *post) updateTableName(table string) *post {
	...
	p.FeaturedImage = field.NewString(table, "featured_image")
	p.AuthorID = field.NewInt64(table, "author_id")
	p.CategoryID = field.NewInt64(table, "category_id")
	p.Status = field.NewString(table, "status")
	p.ReadTime = field.NewString(table, "read_time")
	p.Views = field.NewInt32(table, "views")
	p.Likes = field.NewInt32(table, "likes")
	p.IsFeatured = field.NewBool(table, "is_featured")
	p.MetaTitle = field.NewString(table, "meta_title")
	p.MetaDescription = field.NewString(table, "meta_description")
	p.PublishedAt = field.NewTime(table, "published_at")
...
func (p *post) fillFieldMap() {
	...
	p.fieldMap["featured_image"] = p.FeaturedImage
	...
	p.fieldMap["meta_title"] = p.MetaTitle
	p.fieldMap["meta_description"] = p.MetaDescription
	p.fieldMap["published_at"] = p.PublishedAt
