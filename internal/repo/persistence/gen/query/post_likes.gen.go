...
func newPostLike(db *gorm.DB, opts ...gen.DOOption) postLike {
	...
	_postLike.UserID = field.NewInt64(tableName, "user_id")
	_postLike.LikedAt = field.NewTime(tableName, "liked_at")
...
func (p *postLike) updateTableName(table string) *postLike {
	...
	p.LikedAt = field.NewTime(table, "liked_at")
